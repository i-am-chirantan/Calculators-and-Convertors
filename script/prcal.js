function prcal() {
    ...
    document.getElementById("resa1").value = net_income_a / total_assets_a;
    document.getElementById("resb1").value = net_income_b / total_assets_b;

    return_assets_a = document.getElementById("resa1").value;
    return_assets_b = document.getElementById("resb1").value;
    document.getElementById("resc1").value = indec(return_assets_a, return_assets_b);

    // Calculate return equity
    document.getElementById("resa2").value = net_income_a / share_holders_a;
    document.getElementById("resb2").value = net_income_b / share_holders_b;

    return_equity_a = document.getElementById("resa2").value;
    return_equity_b = document.getElementById("resb2").value;
    document.getElementById("resc2").value = indec(return_equity_a, return_equity_b);

    // Calculate gross profit margin
    document.getElementById("resa3").value = gross_profit_a / sales_a;
    document.getElementById("resb3").value = gross_profit_b / sales_b;

    gross_profit_margin_a = document.getElementById("resa3").value;
    gross_profit_margin_b = document.getElementById("resb3").value;
    document.getElementById("resc3").value = indec(gross_profit_margin_a, gross_profit_margin_b);

    // Calculate operating profit margin
    document.getElementById("resa4").value = operating_profit_a / sales_a;
    document.getElementById("resb4").value = operating_profit_b / sales_b;
    ...
    document.getElementById("resc4").value = indec(operating_profit_margin_a, operating_profit_margin_b);

    // Calculate net profit margin
    document.getElementById("resa5").value = net_income_a / sales_a;
    document.getElementById("resb5").value = net_income_b / sales_b;

    net_profit_margin_a = document.getElementById("resa5").value;
    net_profit_margin_b = document.getElementById("resb5").value;
    document.getElementById("resc5").value = indec(net_profit_margin_a, net_profit_margin_b);

    // Calculate earnings per share
    document.getElementById("resa6").value = net_income_a / common_stock_a;
    document.getElementById("resb6").value = net_income_b / common_stock_b;

    earnings_per_share_a = document.getElementById("resa6").value;
    earnings_per_share_b = document.getElementById("resb6").value;
    document.getElementById("resc6").value = indec(earnings_per_share_a, earnings_per_share_b);

    //Price/Earnings Ratio

    document.getElementById("resa7").value = market_price_a / earnings_per_share_a;
    document.getElementById("resb7").value = market_price_b / earnings_per_share_b;

    price_earnings_ratio_a = document.getElementById("resa7").value;
    price_earnings_ratio_b = document.getElementById("resb7").value;
    document.getElementById("resc7").value = indec(price_earnings_ratio_a, price_earnings_ratio_b);
}
